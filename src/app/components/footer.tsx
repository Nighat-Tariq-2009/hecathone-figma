...
export default function Footer(){
   ...
   <div className="flex-1 md:pl-64 ">
      ...
      <button
         className="bg-[#F5F5F5] w-full max-w-xs p-4 rounded-full text-sm border border-gray-300 text-[12px] flex justify-center items-center"
      >
...
<div className="flex flex-col items-center max-w-screen-2xl mx-auto bg-[#F0F0F0]">
  ...
  <div className="flex flex-col lg:flex-row justify-center items-center gap-4 mt-10 p-5 w-full">
    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-8 w-full lg:w-3/4">
       {/* >COMPANY */}
      <div>
        <h3 className="text-sm font-semibold font-Satoshi mb-2">COMPANY</h3>
      ...
      <div>
        ...
        <p className="text-sm font-normal font-Satoshi mb-2">Customer Support</p>
        <p className="text-sm font-normal font-Satoshi mb-2">Delivery Details</p>
        <p className="text-sm font-normal font-Satoshi mb-2">Terms & Conditions</p>
        <p className="text-sm font-normal font-Satoshi mb-2">Privacy Policy</p>
      </div>
      ...
      <div>
        ...
        <p className="text-sm font-normal font-Satoshi mb-2">Manage Deliveries</p>
        ...
        {/* RESOURCES */}
      <div>
        <h3 className="text-sm font-semibold font-Satoshi mb-2">RESOURCES</h3>
        <p className="text-sm font-normal font-Satoshi mb-2">Free eBooks</p>
        <p className="text-sm font-normal font-Satoshi mb-2">Development Tutorial</p>
        <p className="text-sm font-normal font-Satoshi mb-2">How to - Blog</p>
        <p className="text-sm font-normal font-Satoshi mb-2">Youtube Playlist</p>
      </div>
    </div>
  </div>
  ...
  <div className="w-full border-t border-gray-300 mt-8">
    <div className="flex flex-col md:flex-row justify-between items-center gap-4 p-4">
      ...
      <div>
        <Image src="/images/footer-img.png" width={300} height={50} alt="footer logo" />
      </div>
    </div>
  </div>
</div>
