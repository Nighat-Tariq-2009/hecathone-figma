        ...
        <div className="flex flex-col lg:flex-row md:flex-col justify-center sm:mt-10 sm:p-0">
          ...
          <div className="w-full sm:w-[600px] h-[500px] mt-3 order-3 lg:ml-8 md:ml-40 sm:ml-10">
            ...
            <p className="font-bold mt-1">
              {items.price} <span>{items.old_price}</span>
            </p>
            <p>
            ...
            <div className="mt-5">
              ...
              <div className="flex space-x-3 mt-2">
                <div className="w-[37px] h-[37px] bg-[#4F4631] rounded-full flex justify-center items-center">
                  <FaCheck className="text-white opacity-0 hover:opacity-100 cursor-pointer" />
                </div>
            ...
            <div className="flex justify-start items-center mt-7 space-x-4">
              ...
              <button className="bg-black text-white w-[300px] md:w-[200px] rounded-md p-3">
                Add to Cart
              </button>
            </div>
          </div>
